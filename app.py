...
def create_app(test_config=None):
    ...
    # Route for adding a specific movie
    ...
    # Route for update a specific movie
    ...
    # Route for deleting a specific movie
    ...
    # Route for adding a specific actor
    ...
    # Route for editting a specific actor
    ...
    # Route for deleting a specific actor
